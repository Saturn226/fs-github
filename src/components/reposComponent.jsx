...
export default class reposComponent extends Component {
    ...
    getRepos = () => fetch(`${this.props.repos_url}?sort=updated-desc`) // fetching most recently updated repos
      .then(res => res.json())
    ...
    render() {
      /* creating a limit for the amount of repos to show
      ...
      const limit = Math.min(this.state.repos.length, 4);
